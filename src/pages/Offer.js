    ...
    return (
        <div className="Offer">
            ...
            <ul>
                ...
                <li><span>Terapia narzędziowa tkanek miękkich (IASTM)</span> - jest metodą terapeutyczną wykorzystującą do pracy specjalistyczne narzędzia ze stali chirurgicznej. Zastosowanie tych narzędzi pozwala na skuteczną i bezpieczną terapię zaburzeń systemu powięziowego,  opracowanie blizn,  tkanek okołostawowych np. w przypadku zapalenia torebki stawowej, w uwięźnięciach  nerwów,  w tendinopatiach itp. Efekt terapeutyczny uzyskuje się przez sprowokowanie lokalnego stanu zapalnego, co stymuluje organizm do procesu leczenia i regeneracji-  wchłaniania zwłóknień,  usuwania skutków mikrourazów i reorganizacji zmienionej chorobowo tkanki.</li>
                <li><span>Aquavibron</span> - masaż wibracyjny  stosowany w przypadku wielu różnorodnych dolegliwości. Polega na masowaniu wybranych obszarów ciała za pomocą specjalnego urządzenia. Aparat składa się z wężyka zakończonego gumową głowicą wibracyjną. Działanie urządzenia opiera się o przepływ wody pod ciśnieniem , która wprawia gumową membranę w drgania . Masaż wibracyjny aquavibron jest bezbolesny i przyjemny. Działanie aquavibron polega na stymulacji zakończeń nerwowych - dzięki temu poprawie ulegają zdolności ruchowe mięśni i stawów, polepsza się ukrwienie, a tkanki pobudzone zostają do regeneracji. Tego typu masaż pozwala również się zrelaksować i wyciszyć, przez co wpływa na lepsze samopoczucie. Może być stosowany jako samodzielny masaż (10-15 min.) lub w połączeniu z innymi zabiegami.</li>
            ...
            <ul>
                ...
                <div className="Offer__group__images">
                    <img src={require('../assets/offer/kobido1.jpg')} alt='Masaż kobido Miechów' />
                    <img src={require('../assets/offer/kobido2.jpg')} alt='Masaż kobido Miechów' />
                    <img src={require('../assets/offer/kobido3.jpg')} alt='Masaż kobido Miechów' />
                </div>
                <p>Efekty masażu twarzy Kobido po 1 zabiegu</p>
