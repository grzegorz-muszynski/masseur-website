...
export default function Offer() {
    ...
    return (
        <div className="Offer">
            <h2>Masaż</h2>
            <p>W naszym salonie oferujemy różnorodne techniki masażu:</p>
            <ul>
            ...
            <h2>Pływanie</h2>
            <p>&ensp;&ensp;&ensp;&ensp;Lepiej zapobiegać niż leczyć, dlatego działaj profilaktycznie- naucz się pływać . Pływanie wszechstronnie i dobroczynnie wpływa na wszystkie układy a w szczególności na wzmocnienie mięśni, które , jeśli są sprawne i silne, zapobiegają przedwczesnym zmianom degeneracyjnym stawów. Dodatkowo przebywanie w środowisku wodnym zwiększa wydatek energetyczny (przyspiesza spalanie kalorii w celu utrzymania stałej temperatury ciała) , a dzięki sile wyporu odciąża stawy, sprawia, że wysiłek jest mniej kontuzjogenny niż w przypadku innych dyscyplin.</p>
        </div>
    )
}
